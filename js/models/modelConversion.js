...
angular
    ...
    .factory('BadgeConverter',['BadgeModel', 'UserConverter', BadgeConverter])
    .factory('AnswerConverter',['AnswerModel', 'UserConverter', 'CommentConverter','TagConverter',AnswerConverter])
    .factory('QuestionConverter', ['QuestionModel', 'UserConverter', 'AnswerConverter', 'CommentConverter', QuestionConverter]);
...
function AnswerConverter(AnswerModel,UserConverter, CommentConverter, TagConverter){
    ...
    function convertAnswer(answerObj){
        var keys = {
            ...
            'last_editor':{value:'lastEditor', transformFunc: UserConverter.convertUser},
...
function QuestionConverter(QuestionModel, UserConverter, AnswerConverter, CommentConverter){
    var service = {
...
//            'title':{value:'title'},
            ...
            'upvoted':{value:['currentUser','upvoted']},
            'downvoted':{value:['currentUser','downvoted']},
            'favorited':{value:['currentUser','favorited']},
